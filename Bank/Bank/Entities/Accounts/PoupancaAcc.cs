...
{
    public class PoupancaAcc : Account
    {
        public int Aniversary { get; set; }


        public PoupancaAcc(int aniversary, Person person, double balance, long number)
        {
        ...
        override public void Statement()
        {
            ...
            Console.WriteLine($"Aniversary: {Aniversary}");
